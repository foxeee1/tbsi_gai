...
# Use default fork for data loader workers (PyTorch 1.9 default on Linux).
# Fork is the fastest method; memory overhead is managed by COW semantics.
# Do NOT set fork/spawn/forkserver explicitly — let PyTorch decide.
