...
LOG_DIR="output/diagnostics/soft_search_reliability_v171"
mkdir -p "${LOG_DIR}"
...
run_one() {
  local subset="$1"
  local cfg="v1.7.1-soft-search-reliability-${subset}"
...
echo "[$(date '+%F %T')] ALL DONE v1.7.1 soft search reliability ABC"
