...
LOG_DIR="output/diagnostics/template_search_competition_v172"
mkdir -p "${LOG_DIR}"
...
run_one() {
  local subset="$1"
  local cfg="v1.7.2-template-search-competition-${subset}"
...
echo "[$(date '+%F %T')] ALL DONE v1.7.2 template search competition ABC"
