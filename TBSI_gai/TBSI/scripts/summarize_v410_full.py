...
OUT_DIR = Path("output/diagnostics/fcc_v410_full")
REPORT_NAME = "lasher_test_fcc_v410_full"
...
def main():
    ...
    summary = {
        ...
        "rows": rows,
        "deltas": {
            "v410_minus_baseline": sub_metrics(overall["v4.1.0-fcc-全量"], overall[baseline]),
            "v410_minus_v160": sub_metrics(
                overall["v4.1.0-fcc-全量"], overall["v1.6.0-signal-decouple-v1-全量"]),
            "v410_minus_v165": sub_metrics(
                overall["v4.1.0-fcc-全量"], overall["v1.6.5-signal-decouple-learnscale-all-smax05-init01-全量"]),
        },
        "note": (
            "Baseline full results are reused from output/experiments/v1.0.0-完美基线-全量/test_results "
            "and linked into the standard tracking_results path for apples-to-apples evaluation."
        ),
    }
    out_path = OUT_DIR / "full_attr_compare_v410.json"
