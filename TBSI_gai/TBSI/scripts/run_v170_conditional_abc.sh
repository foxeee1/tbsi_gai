...
LOG_DIR="output/diagnostics/signal_decouple_v170_conditional"
mkdir -p "${LOG_DIR}"
...
run_one() {
  local subset="$1"
  local cfg="v1.7.0-conditional-signal-prop-${subset}"
  local ckpt="output/checkpoints/train/tbsi_track/${cfg}/TBSITrack_ep0015.pth.tar"
...
echo "[$(date '+%F %T')] ALL DONE v1.7.0 conditional ABC"
